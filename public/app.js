								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {page: a, loggedIn: b, title: c, cardText: d, place: e, user: f, cards: g, activeCard: h, activeCardVolunteers: i, activeUser: j, userTakenCards: k, karma: l, popups: m};
												};
											};
										};
									};
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$contenteditable(model.user.moderator),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html_Events$on,
			...
			},
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$viewCardKarmaPrice, 'list', model, card),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$viewCardKarmaPrice, 'full', model, card),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$viewCards, model, model.cards),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$textarea,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$CardText),
						_1: {
							ctor: '::',
